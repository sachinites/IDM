...
file_downloader_state_tostring (state_id_t state_id) {
	...
	switch (state) {
		...
		case DNLOAD_STATE_HEAD_GET_RESPONSE_AWAIT:
			return "DNLOAD_STATE_HEAD_GET_RESPONSE_AWAIT";
 ...
 * DNLOAD_EVENT_CANCEL     	DNLOAD_STATE_FD_CANCELLED			   cancel connector thread, release all resources
 ...
 * DNLOAD_EVENT_CONNECT_FAILED  NA
 *
 * Initial State : DNLOAD_STATE_HEAD_GET_RESPONSE_AWAIT
 * 
